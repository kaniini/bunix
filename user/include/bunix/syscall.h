...
enum {
	...
	BUNIX_PROTO_FS = ('F') | ('S' << 8) | ('R' << 16) | ('V' << 24),
	...
	BUNIX_PROCFS_PROCESS_UPSERT = 4,
	BUNIX_PROCFS_PROCESS_REMOVE = 5,
	BUNIX_PROCFS_PROCESS_CMDLINE_BUFFER = 6,
	...
	BUNIX_LINUX_RESOLVE_FD_PATH = 1012,
	...
	BUNIX_NET_PACKET_RX_SUBMIT_BATCH = 60,
	...
	BUNIX_FS_MKDIR_P_BUFFER = 1,
	BUNIX_FS_SET_META_BUFFER = 2,
	BUNIX_FS_META_MODE_TYPE = 0,
	BUNIX_FS_META_OWNER = 8,
	BUNIX_FS_META_ATIME = 16,
	BUNIX_FS_META_MTIME = 24,
	BUNIX_FS_META_CTIME = 32,
	BUNIX_FS_META_BYTES = 40,
