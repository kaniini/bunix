...
enum {
	...
	BUNIX_PROC_EXEC_LOG_LINUX = 1,
	BUNIX_PROC_EXEC_LOG_MUSL = 2,
	BUNIX_PROC_EXEC_LOG_SHELL = 3,
	BUNIX_PROC_EXEC_LOG_LOGIN = 4,
	BUNIX_PROC_EXEC_LOG_INIT = 5,
	BUNIX_PROC_EXEC_LOG_FIRST = 6,
