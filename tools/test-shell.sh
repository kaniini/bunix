...
printf 'busybox cat /mnt/union/hello.txt && echo UNION_LOWER_OK\necho UNION_UPPER_OK > /mnt/union/created.txt\nbusybox cat /mnt/union/created.txt\nbusybox cat /tmp/union/created.txt && echo UNION_UPPER_BACKING_OK\nbusybox ls /mnt/union | busybox grep created.txt && echo UNION_READDIR_UPPER_OK\nbusybox ls /mnt/union | busybox grep secret.txt && echo UNION_READDIR_LOWER_OK\necho UNION_COPY_OK > /mnt/union/hello.txt\nbusybox cat /mnt/union/hello.txt\nbusybox cat /hello.txt && echo UNION_LOWER_PRESERVED_OK\nbusybox rm /mnt/union/hello.txt && echo UNION_WHITEOUT_RM_OK\nbusybox test ! -e /mnt/union/hello.txt && echo UNION_WHITEOUT_OK\nbusybox ls /mnt/union | busybox grep hello.txt || echo UNION_READDIR_WHITEOUT_OK\nbusybox cat /hello.txt && echo UNION_WHITEOUT_LOWER_OK\n' >&3
